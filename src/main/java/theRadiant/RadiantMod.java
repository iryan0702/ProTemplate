...
import theRadiant.cards.AbstractEasyCard;
import theRadiant.cards.cardvars.AbstractEasyDynamicVariable;
import theRadiant.potions.AbstractEasyPotion;
import theRadiant.relics.AbstractEasyRelic;
import theRadiant.util.LockAndToolTargeting;
import theRadiant.util.LockManager;
import theRadiant.util.LockTargeting;
import theRadiant.util.ProAudio;
import java.nio.charset.StandardCharsets;

@SuppressWarnings({"unused", "WeakerAccess"})
@SpireInitializer
public class RadiantMod implements
    ...
    public RadiantMod() {
        ...
        BaseMod.addColor(TheRadiant.Enums.LOCKSMITH_COLOR, characterColor, characterColor, characterColor,
    ...
    public static void initialize() {
        RadiantMod thismod = new RadiantMod();
    }

    @Override
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new TheRadiant(TheRadiant.characterStrings.NAMES[1], TheRadiant.Enums.THE_LOCKSMITH),
            CHARSELECT_BUTTON, CHARSELECT_PORTRAIT, TheRadiant.Enums.THE_LOCKSMITH);
    ...
    public void receivePostInitialize() {
        ...
        CustomTargeting.registerCustomTargeting(LockAndToolTargeting.LOCK_AND_TOOL_TARGET, new LockAndToolTargeting());
    }
}
