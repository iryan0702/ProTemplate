...
import theRadiant.util.TexLoader;
...
public abstract class AbstractEasyPower extends AbstractPower {
    ...
    public AbstractEasyPower(String ID, String NAME, PowerType powerType, boolean isTurnBased, AbstractCreature owner, int amount) {
        ...
        Texture normalTexture = TexLoader.getTexture(RadiantMod.modID + "Resources/images/powers/" + ID.replaceAll(RadiantMod.modID + ":", "") + "32.png");
        Texture hiDefImage = TexLoader.getTexture(RadiantMod.modID + "Resources/images/powers/" + ID.replaceAll(RadiantMod.modID + ":", "") + "84.png");
        if (hiDefImage != null) {
