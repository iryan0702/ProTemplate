...
import theRadiant.cards.*;
import theRadiant.relics.TodoItem;

import java.util.ArrayList;

import static theRadiant.TheRadiant.Enums.LOCKSMITH_COLOR;
import static theRadiant.RadiantMod.*;

public class TheRadiant extends CustomPlayer {
    ...
    public TheRadiant(String name, PlayerClass setClass) {
    ...
    public AbstractPlayer newInstance() {
        return new TheRadiant(name, chosenClass);
    }
