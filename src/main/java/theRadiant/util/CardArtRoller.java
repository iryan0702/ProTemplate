...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(RadiantMod.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(RadiantMod.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(RadiantMod.makeImagePath("masks/PowerMask.png"));
