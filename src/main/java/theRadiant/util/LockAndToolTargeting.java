...
public class LockAndToolTargeting extends TargetingHandler<Integer> {
    @SpireEnum
    public static AbstractCard.CardTarget LOCK_AND_TOOL_TARGET;
    ...
    public void updateHovered() {
        ...
        if(InputHelper.mX > Settings.WIDTH/8*7 && InputHelper.mY < Settings.HEIGHT/2) {
            hovered = 999;
        }
    }
