...
import theRadiant.util.CardArtRoller;

import static theRadiant.RadiantMod.makeImagePath;
import static theRadiant.RadiantMod.modID;
import static theRadiant.util.Wiz.*;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, TheRadiant.Enums.LOCKSMITH_COLOR);
    }
