...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(LocksmithMod.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(LocksmithMod.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(LocksmithMod.makeImagePath("masks/PowerMask.png"));
